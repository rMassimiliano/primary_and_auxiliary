...
beta_y[2] = ifelse(effect,Y_effect_reduction*beta_s[2] ,0)
 ...
 return(list(data = trialData, beta_y = beta_y, beta_s = beta_s, effect = effectk, residual_Y_effect = effect_reductionk))
 }
