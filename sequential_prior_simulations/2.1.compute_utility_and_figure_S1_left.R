...
ggplot() + 
geom_point(aes(x = beta, ExpU, col = factor(gamma))) +
geom_smooth(aes(x = beta, ExpU, col = factor(gamma)), se = FALSE, span = 0.4) +
labs(x = "beta (futility)", y = "Utility", col = "beta (efficacy)")  +
geom_vline(xintercept = 0.13, lty = 'dashed')+
scale_color_brewer(palette = "Set2")+
theme_classic(11)
#ggsave("optimal_solution_seq.png", width = 7, height =  5)
